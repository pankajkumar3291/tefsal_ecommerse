...
public class GetCartRecord implements Serializable {
    ...
    private IndividualDiscount product_discount;
    public IndividualDiscount getDiscount() {
        return product_discount;
    }
    public void setDiscount(IndividualDiscount discount) {
    ...
    public float getDisCountedAmount() {
        float totalAmount = Float.parseFloat(getTotal_amount());
        float discountRate;
        if (getDiscount() == null) {
            discountRate = 0.0f;
        } else {
            discountRate = getDiscount().getDiscountPercentage();
        }
