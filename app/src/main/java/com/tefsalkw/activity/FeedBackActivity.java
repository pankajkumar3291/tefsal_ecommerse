...
public class FeedBackActivity extends BaseActivity {
    ...
    private void httpFeedBackCall()
    {

        SimpleProgressBar.showProgress(FeedBackActivity.this);
        try {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response != null)
                            {
                                ...
                                try
                                {
                                   ...
                                   feed_text.setText(records.getString("description"));
