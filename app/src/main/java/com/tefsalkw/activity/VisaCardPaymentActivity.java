...
public class VisaCardPaymentActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visa_card_payment);
        ...
        try {
            ...
            String paymentUrl = paymentBaseUrl + "/knet/buy.php?amount=" + amount + "&user_id=" + userId + "&cart_id=" + cartId + "&track_id=" + first11+"&channel=ANDROID";

            Log.e("paymentUrl", paymentUrl);

            SimpleProgressBar.showProgress(VisaCardPaymentActivity.this);
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(VisaCardPaymentActivity.this);
    ...
    private class MyWebViewClient extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (url.contains(paymentBaseUrl + "/knet/result.php")) {
                ...
                try {
                    ...
                    if (result != null && result.equals("CAPTURED")) {
                        ...
                        startActivity(new Intent(VisaCardPaymentActivity.this, TransactionStatusActivity.class).putExtra("TxnStatus", "0").addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK));
            ...
            if (url.contains(paymentBaseUrl + "error")) {
                ...
                try {
                    ...
                    Toast.makeText(VisaCardPaymentActivity.this, "Payment didn't go through, please try again", Toast.LENGTH_LONG).show();
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            Toast.makeText(VisaCardPaymentActivity.this, "Error occurred. Please try again!", Toast.LENGTH_LONG).show();
            finish();
        }
    }
                ...
                try {
                    ...
                    try {
                        ...
                        if (jsonObject.getInt("status") == 1) {
                            ...
                            startActivity(new Intent(VisaCardPaymentActivity.this, TransactionStatusActivity.class).putExtra("TxnStatus", "1").addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK));
